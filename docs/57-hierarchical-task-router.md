...
3. Identify the data source: static RP, title/actionbar/chat payload, server form collection, scoreboard collection, Script API, or another server sender.
...
| --- | --- | --- | --- | --- | --- |
| HUD | RPG/status bars | HP, mana, stamina, XP bars | `docs/34-binding-patterns-value-index.md`, `docs/54-visual-fit-and-reference-discipline.md` | `references/local-examples/rpg-hud/ui/rpg_hud.json`, `references/local-examples/multi-animated-progress/ui/animated_bar.json` | `RP/ui/hud_screen.json` |
...
| Chat | notifications | topbar/chat notification, hidden protocol line | `docs/34-binding-patterns-value-index.md`, `docs/38-advanced-json-ui-recipes.md` | `references/local-utils/json-ui-utils/topbar_chat_notification_utils.json` | `RP/ui/chat_screen.json`, `RP/ui/hud_screen.json` |
...
| Container | chest/inventory | slot menu, item grid, custom container | `docs/18-tooling-auxgen-dumper-starlib.md`, `docs/47-custom-auxid-and-form-progress.md` | chest UI references | `RP/ui/chest_screen.json`, `RP/ui/server_form.json` |
