...
For direct JSON UI schema URLs, sprite UI schema coverage, screen/type/property catalogues, or comparison against Bugrock JSON UI schema coverage, use `mcbe-json-ui-schemas` and `skills/mcbe-json-ui-schemas/references/schema-map.md`.
