...
export const RUNTIME_CUSTOM_RENDERER_UNAVAILABLE = "RUNTIME_CUSTOM_RENDERER_UNAVAILABLE";
...
export function buildDisplayList(layout) {
  ...
  for(const[index,node]of(layout.nodes||[]).entries()){
    ...
    }else if(type==="custom"&&props.renderer)commands.push({...base,op:"runtimeCustomRenderer",type:"runtimeCustomRenderer",renderer:props.renderer,propertyBag:props.property_bag??null});
